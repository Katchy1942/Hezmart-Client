            ...
            <div className="bg-white shadow-sm rounded-2xl overflow-hidden">
               <div className="px-4 py-5 sm:p-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                     ...
                     <div>
                        <h3 className="text-lg font-semibold leading-6 text-gray-900 mb-4  ">Personal Information</h3>
                     ...
                     <div className="pt-8">
                        <h3 className="text-lg font-semibold leading-6 text-gray-900 mb-4  ">Security</h3>
                        <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                     ...
                     <div className="">
                        <h3 className="text-lg font-semibold leading-6 text-gray-900 mb-4  ">Business Details</h3>
                        <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                           <div className="sm:col-span-2">
                              <InputField
                                 label="Business Name"
