      ...
      <form onSubmit={handleSubmit} className="relative w-full max-w-full">
         <div className="relative flex items-center group">
            ...
            <input
               ref={inputRef}
               type="text"
               className={`block w-full pl-12 pr-24 md:py-2 py-3 bg-gray-100 border-2 border-transparent rounded-full leading-5 
            ...
            <button
               ...
               className="absolute right-1.5 top-1.5 bottom-1.5 px-6 bg-primary-light 
                        hover:bg-primary-dark text-white text-sm font-medium rounded-full cursor-pointer
