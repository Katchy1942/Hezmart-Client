...
const Header = () => {
   ...
   const UserAvatar = ({ user }) => {
      return (
         <div
            className="w-6 h-6 rounded-full bg-primary-light
      ...
      <div className="bg-[#f1f1f2]">
               ...
               {!isMobile && (
                  <nav
                     className="hidden px-4 sm:px-6 lg:px-8
                            ...
                            max-w-[1440px] mx-auto w-full gap-4"
                  >
                     <div className="flex-shrink-0 flex justify-start items-center gap-6">
                        <Link to='/' className="flex-shrink-0">
                           <img
                              src={logo}
                              alt="Logo"
                              className="w-36 object-contain transition-transform hover:scale-105"
                           />
                        </Link>
                        ...
                        >
                           <div
                              ...
                              className={`cursor-pointer transition-colors text-sm font-semibold bg-gray-100 py-2 px-3 rounded-full flex items-center gap-1.5 select-none whitespace-nowrap
                                          ${isCategoryDropdownOpen ? 'text-primary-light' : 'text-gray-600 hover:text-primary-light'}`}
                           >
                              Categories
                              <FiChevronDown
                     ...
                     <div className="flex-1 max-w-xl px-4 min-w-[200px]">
                        <SearchBar
                           placeholder="Search products, brands and categories"
                           onSearch={handleSearch}
                           results={searchResults}
                     ...
                     >
                        {user && (
                           <Link
                              ...
                              className="hidden sm:flex items-center gap-2 px-3 py-2
                                         ...
                                         text-emerald-700 rounded-full transition-all 
                                         hover:bg-emerald-100 hover:shadow-sm"
                           >
                              <span className="text-sm font-bold tracking-tight">
                                 ₦{formatBonus(realUser?.bonus || user?.bonus || 0)}
                              </span>
                           </Link>
                        )}
                           ...
                           <div className="relative" ref={dropdownRef}>
                              <button
                                 ...
                                 className="flex items-center gap-2
                                            ...
                                            ring-gray-200 rounded-full py-1.5 px-3
                        ...
                        <Link
                           to="/cart"
                           className="group relative flex h-10 w-10
                        ...
                        <div className="relative group">
                           <button
                              className="flex h-10 w-10 items-center justify-center 
                                         rounded-full bg-gray-100 text-gray-600 shadow-sm 
                                         transition-all duration-300 hover:bg-gray-200 
                                         hover:text-primary-light focus:outline-none cursor-pointer"
                           >
                           ...
                           >
                              <div className="py-2">
                                 <Link
                                    to="/sell-on-hezmart"
                                    className="block px-4 py-2.5 mx-2 rounded-lg text-sm text-gray-700 hover:bg-gray-50 hover:text-primary-light transition-colors"
                                 >
                                    Sell on Hezmart
                                 </Link>
                                 <Link
                                 ...
                                 <a
                                    href="tel:09160002490"
                                    className="block px-4 py-2.5 mx-2 rounded-lg text-sm font-medium text-primary-light hover:bg-primary-light/5 transition-colors"
                                 >
         ...
         >
            ...
            >
               {user && (
                  <Link
                     ...
                     className="flex items-center gap-2 px-3 py-2
                                ...
                                hover:bg-emerald-100 hover:shadow-sm"
                  >
                     <span className="text-sm font-bold uppercase tracking-tight">Earnings</span>
                     <span className="text-sm font-bold tracking-tight">
                        ₦{formatBonus(realUser?.bonus || user?.bonus || 0)}
                     </span>
                  </Link>
               ...
               <button
                  ...
                  className="font-black shadow-sm flex items-center
                        justify-center h-10 w-10 border-0 ring-1
                        ring-gray-200 rounded-full ml-auto"
               >
         ...
         <div
            className={`fixed inset-0 bg-black/50 z-40 lg:hidden
                transition-opacity duration-300 ${isMobileMenuOpen
                  ? 'opacity-100'
