                        ...
                        {shops.length > 0 ? (
                           shops.map((shop) => (
                              <tr key={shop.id} className="hover:bg-gray-50">
                                 ...
                                 <td className="px-6 py-4 whitespace-nowrap">
                                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${shop.category === "Fashion" ? "bg-purple-100 text-purple-800" :
                                          ...
                                          <div className="py-1">
                                             {getStatusActions(shop.status).map((action) => (
                                                <button
                                                   ...
                                                   disabled={statusUpdating === shop.id}
                                                   className={`block px-4 py-2 text-sm w-full text-left ${statusUpdating === shop.id
